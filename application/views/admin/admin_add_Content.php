        ...
        <div class="content content-full">
            <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center border-bottom border-primary">
                <h1 class="flex-sm-fill h3 my-2">
                    CONTENT <small class="d-block d-sm-inline-block mt-2 mt-sm-0 font-size-base font-w400 text-muted"></small>
                </h1>
            ...
            <div class="col-xl">
                <div class="block block-themed block-transparent mb-0">
                        <div class="block-header bg-primary-dark">
                            ...
                            <form action="<?php echo site_url('admin_c/add_content/'); ?>" method="post" enctype="multipart/form-data">
                                <div class="block-content font-size-sm">
                                    <div class="form-group">
                                        <label>Train name</label>
                                        <input type="text" class="form-control" id="example-text-input" name="train_name" placeholder="Train name" value="">

                                    </div>
                                    <div class="form-group">
                                        <label>Origin</label>
                                        <input type="text" class="form-control" id="example-text-input" name="origin" placeholder="Origin" value="">

                                    </div>
                                    <div class="form-group">
                                        <label>Destinantion</label>
                                        <input type="text" class="form-control" id="example-text-input" name="destinantion" placeholder="Destinantion" value="">

                                    </div>
                                    <div class="form-group">
                                        <label>Tag Rear</label>
                                        <input type="text" class="form-control" id="example-text-input" name="tag_rear" placeholder="Announcement" value="">
                                        
                                    </div>
                                    <div class="form-group">
                                        <label>Tag Front</label>
                                        <input type="text" class="form-control" id="example-text-input" name="tag_front" placeholder="Announcement" value="">
                                        
                                    </div>
                                    <div class="form-group">
                                        <label>Announcement</label>
                                        <input type="text" class="form-control" id="example-text-input" name="announcement" placeholder="Announcement" value="">
