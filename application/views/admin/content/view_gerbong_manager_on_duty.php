                    ...
                    <div class="content content-full">
                        <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center">
                            <h1 class="flex-sm-fill h3 my-2">
                                Manager On Duty Gerbong (PIDS 2)
                            </h1>
                            ...
                            <nav class="flex-sm-00-auto ml-sm-3" aria-label="breadcrumb">
                                <ol class="breadcrumb breadcrumb-alt">
                                    ...
                                    <li class="breadcrumb-item" aria-current="page">
                                        <a class="link-fx" href="">Manager On Duty Gerbong (PIDS 2)r</a>
                                    </li>
                                </ol>
                            </nav>
                        </div>
                            ...
                            <table id="myTable" class="table table-bordered table-striped" style="width: 100%; font-size: 12px;">
                                <thead>
                                    <tr>
                                        ...
                                        <td rowspan="2">Nama Kereta</td>
                                        <td rowspan="2">Kode Kereta</td>
                                        <td colspan="2">Manager On Duty</td>
                                        <td>Free Announce Text</td>
                                        <td rowspan="2">AAS</td>
                                        <td rowspan="2">Next Station</td>                                   
                                    </tr>
                                    <tr>
                                        <td colspan="3" align="center">Play Interval</td>
                                    </tr>
                                </thead>
                                <tbody>
                                   <tr>
